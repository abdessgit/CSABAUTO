...
class RendezVousController extends AbstractApiController
{
    ...
    #[Route('', methods: ['GET'])] public function list(RendezVousRepository $repo): JsonResponse { $items = $this->security->isGranted('ROLE_MODERATEUR') ? $repo->findAll() : $repo->findBy(['client' => $this->security->getUser()]); return $this->jsonRead($items, 'rendezvous:read', $this->serializer); }
